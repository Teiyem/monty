...
/**
 * struct s_queue_s - contains extra metadata of a stack queue or queue
 * @lifo: The stack or queue
 * @cont: The current line
 * @arg: The second parameter inside the current line
 * @head: The doubly linked list
 * @fd: The file descriptor
 * @buffer: The input text
 * Description: structure for stack, queues, LIFO, FIFO
 */
typedef struct s_queue_s
{
	int lifo;
	unsigned int cont;
	char  *arg;
